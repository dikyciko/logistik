...
<html lang="en">
   <head>
      ...
      <title>Baruna Raya Logistik</title>
      <!-- StyleSheets -->
   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">PT BARUNA RAYA LOGISTIK</a>
         ...
         <div class="banner">
            <div class="layer">
               <div class="row Section">
                  ...
                  <div class="col headerImg" style="background-image: url('<?php echo base_url()?>assets/img/baruna.png');"></div>
